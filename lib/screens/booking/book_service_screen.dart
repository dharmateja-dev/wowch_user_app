      ...
      body: Body(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              if (widget.selectedPackage == null)
                Text(language.service, style: context.boldTextStyle()),
              ...
              //Booking data & slot
              16.height,
              Text(language.bookingDateAndSlot, style: context.boldTextStyle()),
              8.height,
              ...
              Column(
                ...
                children: [
                  ...
                  16.height,
                  Text(language.disclaimer, style: context.boldTextStyle()),
                  8.height,
                  Text(
    ...
    return Column(
      children: [
        if (widget.data.isAvailableAtShop && selectedShop != null)
          ...
          Text(language.noteAddressIsNot, style: context.secondaryTextStyle())
              .paddingTop(16),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(language.duration, style: context.primaryTextStyle()),
                    4.height,
                    Text(
                      convertToHourMinute(
    ...
    if (!widget.data.serviceDetail!.isFreeService)
      return Column(
        ...
        children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: LightThemeColors.primaryGreenLite,
                  ...
                  8.width,
                  Text(language.lblCoupon, style: context.primaryTextStyle()),
                  Spacer(),
                  GestureDetector(
                    onTap: () {
          ...
          24.height,
          Text(language.priceDetail, style: context.boldTextStyle()),
          16.height,
          Container(
            padding: const EdgeInsets.all(12),
            width: context.width(),
                            ...
                            if (widget.data.taxes.validate().isNotEmpty)
                              Icon(Icons.info_outline_rounded,
                                ...
                                () {
                                  showModalBottomSheet(
                                    backgroundColor:
                                        context.bottomSheetBackgroundColor,
                                    context: context,
                                    builder: (_) {
            ...
            TextButton(
              onPressed: () async {
                await showModalBottomSheet(
                  ...
                  barrierColor: context.onSurface.withValues(alpha: 0.5),
                  showDragHandle: true,
                  constraints:
              ...
              child: Text("Change",
                  style: context.boldTextStyle(size: 14, color: primaryColor)),
            ),
          ],
        ),
        Container(
          ...
          decoration: boxDecorationDefault(
            ...
            border: Border.all(color: context.dividerOnSecondaryContainerColor),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(selectedShop!.name, style: context.boldTextStyle()),
                      4.height,
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            '${language.email}:',
                            style: context.boldTextStyle(
                                size: 12, color: context.onSecondaryContainer),
                          ).expand(),
                          8.width,
                          Expanded(
                            flex: 4,
